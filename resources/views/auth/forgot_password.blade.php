...
<div class="form-content">
    ...
    <h1 class="title mt-3">Forgot Password</h1>
    <p class="subtitle">Please input your email below.</p>
    <form class="text-left" id="form" action="{{ url('/api/forgot-password') }}" method="POST">
        @csrf
        <div class="form">
